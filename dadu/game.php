...
class Game
{
    ...
    public function __construct($numberOfPlayer, $numberOfDicePerPlayer)
    {
        ...
        for ($i = 0; $i < $this->numberOfPlayer; $i++) {
            $this->players[$i] = new Player($this->numberOfDicePerPlayer, $i, chr(49 + $i));
        }
    }
    ...
    {
        echo "<h1>Pemenang</h1>\r\n";
        echo "Game berakhir karena hanya tersisa 1 Pemain yang masih memiliki dadu<br>";
        echo "Game Di Menangkan oleh pemain #{$player->getName()} karena memiliki poin lebih banyak dari pemain lainnya<br>\r\n ";
        return $this;
    }
